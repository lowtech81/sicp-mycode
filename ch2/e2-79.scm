...
(define complex2 (make-complex-from-real-imag 5 12))

(equ? complex1 complex2)

(define complex3 (make-complex-from-mag-ang 3 4))
(define complex4 (make-complex-from-mag-ang 3 4))

(equ? complex3 complex4)

(define rat1 (make-rational 1 2))
(define rat2 (make-rational 2 4))
(equ? rat1 rat2)

(define rat3 (make-rational 1 2))
(define rat4 (make-rational 3 4))
(equ? rat3 rat4)